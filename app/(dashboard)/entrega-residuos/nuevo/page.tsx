...
export default function NuevaEntregaResiduoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!error) {
      ...
      alert("Error al registrar relación")
    }
  }

  return (
    <div className="p-6 max-w-xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Nueva Relación Entrega-Residuo</h1>
